...
import InfluencerImg from "@/public/assets/FavouriteInfluencer.png";
type InfluencerItem = {
  influencer: string;
  followers: string;
  averageXS: string;
...
const DesktopFavouriteInfluencer = () => {
  return (
    <div className="mt-2 py-6 pb-20 m-auto w-full mdl:max-w-[1164px] px-4 md:px-6 ">
        ...
        {repeatedItems.map((item, index) => (
          ...
          >
            <div className="flex items-center gap-2 w-full">
              ...
              />
              <h4 className="text-mainColor text-[13px]">{item.influencer}</h4>
            </div>
            {[
              "followers",
              "averageXS",
...
export default DesktopFavouriteInfluencer